...
describe('Departments page', function() {
  ...
  beforeEach(function() {
    var fromHomeToUsers = function() {
      ...
      browser.sleep(750);
      element(by.cssContainingText('section.sidebar div.panel-drop-down ul li div.item-name p', 'Departments')).click();
    };
  ...
  describe('grid', function() {
    ...
    it('navigates to the details page when a row is clicked', function() {
      ...
      firstGridRow.getAttribute('data-mi-resource-id').then(function(resourceid) {
        expect(browser.getCurrentUrl()).toContain('#/home/admin/departments/edit/'+resourceid);
      });
    });
  });
  
  describe('details page', function() {
    it('changes Department ID value to uppercase', function() {
      var firstGridRow = element(by.css('.administration > div.data-grid-container > div.k-grid div.k-grid-content tbody tr.k-master-row:first-child')),
  ...
  afterEach(function() {
    screenshot.takeScreenshot(jasmine.getEnv().currentSpec, '/home/administration/departments');
