...
angular.module('voyagerUiApp').directive('miLocationItemsDataGrid',
			...
			link: {
				pre: function(scope, element, attrs) {
					...
					scope.columns = [
						...
						{id:'Tracking', title:scope.resourcesObj.Resources.Item.Properties.Tracking.DisplayText, template:Items.trackingToString, field:'Tracking', headerAttributes:{'class':'string-field'}, attributes:{'class':'string-field'}, width:225},
