/**
 * @ngdoc directive
 * @name voyagerUiApp.directive:miCountryField
 * @restrict E
 *
 * @description
 ...
 *
 * Add the markup <mi-country-list-field data-ng-model='selectedCountry'></mi-country-list-field>
 * Add the dependency to your app's module angular.module('myApp', ['miCountryListField']);
 */

angular.module('voyagerUiApp')
	.directive('miCountryListField', ['$parse', function($parse) {
		'use strict';
		var countries = [
		...
		return {
			...
			templateUrl: 'views/directives/mi-fields/mi-country-list-field.html',
			replace: true,
			scope: {
				miFieldProperty: '@',
				ngModel: '=',
