angular.module('voyagerUiApp').controller('SuppliersSelectionCtrl',
	function(ChangeEvents, $scope, $state, $stateParams, ViewModes ) {
		...
		$scope.parentState = 'base.home.master-files.suppliers';
		...
		//React to Supplier changes
		$scope.$on(ChangeEvents.names.Supplier, function(event, args) {
