angular.module('voyagerUiApp').controller('MasterFilesLocationsSelectionCtrl',
	function (ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.master-files.locations';
		...
		$scope.$on(ChangeEvents.names.Location, function(event, args) {
