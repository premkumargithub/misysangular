angular.module('voyagerUiApp').controller('JobsSelectionCtrl',
	function (ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.master-files.jobs';
		...
		$scope.$on(ChangeEvents.names.Job, function(event, args) {
