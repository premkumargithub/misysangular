angular.module('voyagerUiApp').controller('BomsSelectionCtrl',
	function (ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.master-files.boms';
		...
		//React to Bom changes
		$scope.$on(ChangeEvents.names.Bom, function(event, args) {
