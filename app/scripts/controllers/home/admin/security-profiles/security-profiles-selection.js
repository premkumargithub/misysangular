angular.module('voyagerUiApp').controller('AdminSecurityProfilesSelectionCtrl',
	function(ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.admin.securityProfiles';
		...
		//React to SecurityProfiles changes
		$scope.$on(ChangeEvents.names.SecurityProfile, function(event, args) {
