angular.module('voyagerUiApp').controller('AdminDepartmentSelectionCtrl',
	function (ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.admin.departments';
		...
		$scope.$on(ChangeEvents.names.Department, function(event, args) {
