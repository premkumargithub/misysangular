...
angular.module('voyagerUiApp').controller('AdminWorkflowsSelectionCtrl',
	function(ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.admin.workflows';
		...
		//React to Workflows changes
		$scope.$on(ChangeEvents.names.Workflow, function(event, args) {
