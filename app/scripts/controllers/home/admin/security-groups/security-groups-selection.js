angular.module('voyagerUiApp').controller('AdminSecurityGroupsSelectionCtrl',
	function (ChangeEvents, $scope, $state, $stateParams, ViewModes) {
		...
		$scope.parentState = 'base.home.admin.security-groups';
		...
		$scope.$on(ChangeEvents.names.SecurityGroup, function(event, args) {
